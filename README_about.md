...
* **Векторизация кода:** Автоматическое разбиение и векторизация файлов различных типов (JS/TS, SQL, Markdown) с учётом структуры языка — функции, классы, таблицы, процедуры.
* **Умный парсинг:** Специализированные сплиттеры для каждого типа файлов: `splitJavaScriptByObjects`, `splitSqlByObjects`, `splitMarkdownBySections`.
